...
# Import the enhanced blocks with SE and SqueezeExcitationBlock
from models.residual_blocks.se_blocks import EncoderBlockResidualSE, DecoderBlockResidualSE, SqueezeExcitationBlock

class UNetResidualSE(pl.LightningModule):
    """
    Enhanced U-Net architecture with residual connections, dilated bottleneck with
    self-attention, and Squeeze-Excitation blocks for mel-spectrogram reconstruction.
    
    SE blocks are applied to deeper layers for better feature recalibration.
